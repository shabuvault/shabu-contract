...
contract ShabuWhitelistSale {
  ...
  uint256 LIMIT_BUY = 2 ether;
  ERC20 public Token = ERC20(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
  constructor() public {
    owner = msg.sender;
  }
  ...
  function deposit() public payable {
       // Validation
    require(startDate > 0 && now.sub(startDate) <= DURATION);
  ...
  function whitelistCheck(address _address) public view returns(bool) {
